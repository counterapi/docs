...
!!! info "V2 is now the only available API version"
    As of **August 7, 2026**, the legacy [V1 API](v1.md) has been deprecated and is no longer available. V2 is the current and only supported version of the CounterAPI.
